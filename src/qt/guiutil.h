...
/** Utility functions used by the ZARHEXCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render ZARHEXCASH addresses in monospace font
...
// Parse "zarhexcash:" URI into recipient object, return true on successful parsing
