...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ZARHEXCASH server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ZARHEXCASH server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getblocktime", &getblocktime, true, false, false},
        {"blockchain", "getlastreward", &getlastreward, true, false, false},
        ...
        /* ZARHEXCASH features */
        {"zarhexcash", "masternode", &masternode, true, true, false},
        {"zarhexcash", "masternodelist", &masternodelist, true, true, false},
        {"zarhexcash", "mnbudget", &mnbudget, true, true, false},
        {"zarhexcash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"zarhexcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zarhexcash", "mnsync", &mnsync, true, true, false},
        {"zarhexcash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"zarhexcash", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zarhexcashd, or the -server option to zarhexcash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zarhexcash-cli " + methodname + " " + args + "\n";
}
