...
*Setup instructions for a gitian build of ZARHEXCASH using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the ZARHEXCASH
...
- [Building ALQO](#building-zarhexcash)
...
Clone the git repositories for zarhexcash and gitian and then checkout the zarhexcash version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the zarhexcash repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the zarhexcash repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/zarhexcash/.git/
...
./bin/gbuild --commit zarhexcash=${COMMIT} --url zarhexcash=${URL} ../zarhexcash/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit zarhexcash=${COMMIT} --url zarhexcash=${URL} ../zarhexcash/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit zarhexcash=${COMMIT} --url zarhexcash=${URL} ../zarhexcash/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/zarhexcash-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/zarhexcash-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/zarhexcash-build.assert
```
...
[zarhexcash/gitian.sigs](https://github.com/zarhexcash-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
