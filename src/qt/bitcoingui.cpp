                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZARHEXCASH-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZARHEXCASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zarhexcash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZARHEXCASH Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZARHEXCASH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZARHEXCASH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZARHEXCASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZARHEXCASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZARHEXCASH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZARHEXCASH Core help message to get a list with possible ZARHEXCASH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZARHEXCASH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZARHEXCASH network", "", count));
}
...
{
    QString strTitle = tr("ZARHEXCASH Core"); // default title
