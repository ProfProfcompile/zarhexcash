/* src/config/zarhexcash-config.h.  Generated from zarhexcash-config.h.in by configure.  */
/* src/config/zarhexcash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ZARHEXCASH_CONFIG_H

#define ZARHEXCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://zarhexcashpay.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ZARHEXCASH Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZARHEXCASH Core 1.2.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zarhexcash"
