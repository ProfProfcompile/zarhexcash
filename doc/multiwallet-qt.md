...
In order to support loading of multiple wallets in zarhexcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zarhexcash.cpp.
...
Changes to zarhexcash.cpp
----------------------
zarhexcash.cpp is the entry point into zarhexcash-qt, and as such, will require some minor modifications to provide hooks for
