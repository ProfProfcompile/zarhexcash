...
Value getgenerate(const Array& params, bool fHelp) {
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "It is set with the command line argument -gen (or zarhexcash.conf setting gen)\n"
...
Value getblocktemplate(const Array& params, bool fHelp) {
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "ZARHEXCASH is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "ZARHEXCASH is downloading blocks...");
    ...
    result.push_back(Pair("developerfee_wallet", "GN7fZCAid5wTg1H67uz7bWv8pa5g7pNqDX"));
    return result;
}
