...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ZARHEXCASH Core zarhexcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zarhexcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zarhexcash transaction") + "\n" +
                               "  zarhexcash-tx [options] -create [commands]   " + _("Create hex-encoded zarhexcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zarhexcash transaction
